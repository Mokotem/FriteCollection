...
public class MonoGameDefault : MonoGame
{
    ...
    public override FriteCollection.Environment[] Environments => new FriteCollection.Environment[2] { game, ui };
    ...
    public override void UpdateEnvironments()
    {
        ...
        game = new FriteCollection.Environment(rect,
            new RenderTarget2D(base.GraphicsDevice, S.GameFixeWidth, S.GameFixeHeight));
        ui = new FriteCollection.Environment(rect,
    ...
    protected override void OnDraw(GameTime gameTime)
    {
        ...
        {
            exe.BeforeDraw(ref SpriteBatch);
        }
...
public class MonoGameDefaultPixel : FriteModel.MonoGame
{
    ...
    private static FriteCollection.Environment game;
    internal float aspectRatio;

    public override FriteCollection.Environment[] Environments => new FriteCollection.Environment[1] { game };
    ...
    public override bool FullScreen
    {
        ...
        set
        {
            ...
            UpdateEnvironments();
            Space.SetDefaultEnvironment(in game);
            FriteCollection.UI.UI.Rectangle.SetDefaultEnvironment(in game);
